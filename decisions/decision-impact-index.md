...
| `hotmart-monitoramento-dashboard-cupom` | Priorizar confiabilidade operacional com fallback por cupom + dashboard interno | Hardening de webhook, monitoramento interno e governança de PR em ciclo único | [../initiatives/hotmart-monitoramento-dashboard-cupom/summary.md](../initiatives/hotmart-monitoramento-dashboard-cupom/summary.md) + [../timeline/2026-04-11-hotmart-monitoramento-dashboard-cupom.md](../timeline/2026-04-11-hotmart-monitoramento-dashboard-cupom.md) | Menor risco de erro de atribuição e maior visibilidade de entrega | Em integrações críticas, observabilidade e fallback devem subir juntos |
