...
```mermaid
flowchart LR
	P[Problema: aprendizado preso no privado] --> D[Decisão: publicar vitrine sanitizada]
	D --> A[Ações: fluxo com PR, curadoria e revisão]
	A --> R[Resultado: case público rastreável e repetível]
```
